...
/*  root: 0.66rem = 10.56, 0.72rem = 11.52, 0.75rem = 12, 0.78rem = 12.48,     */
/*  0.81rem = 12.96, 0.85rem = 13.6, 0.88rem = 14.08, 0.9rem = 14.4,          */
/*  1.1rem = 17.6. The `clamp()` sizes resolve to their lower bound at phone   */
/*  width, and `--premium-radius`/`-lg` drop to 14/18 in the mobile block.     */
/* -------------------------------------------------------------------------- */
  ...
  return (
    ...
    >
      ...
      <View style={styles.callout}>
        <LucideIcon name="info" size={15} color={webColors.cyan} />
        <Text style={styles.calloutText}>
          This is your full <Text style={styles.calloutStrong}>follower list</Text> —
          everyone who follows you, tagged with badges like{' '}
          <Text style={styles.calloutStrong}>Top Supporter</Text>,{' '}
          <Text style={styles.calloutStrong}>Session Regular</Text>, and{' '}
          <Text style={styles.calloutStrong}>New Follower</Text> that show how engaged
          each fan is. Scan for the highest coin totals and{' '}
          <Text style={styles.calloutStrong}>Top Supporter</Text> badges to spot
          who&apos;s worth a personal thank-you or an early heads-up before you go live.
        </Text>
      </View>
      ...
      <View style={styles.pulseCard}>
        <LinearGradient
          ...
          pointerEvents="none"
        />
        {/* radial-gradient(120% 160% at 15% 0%, pink) */}
        <LinearGradient
          ...
          pointerEvents="none"
        />
        {/* radial-gradient(120% 160% at 90% 100%, purple) */}
        <LinearGradient
        ...
        <View style={styles.pulseLeft}>
          ...
          <View style={styles.eyebrow}>
            <LucideIcon name="heart" size={12} color={webColors.pinkHot} />
      ...
      {/* .follower-grid — one column at phone width */}
...
const styles = StyleSheet.create({
  ...
  /* .pulse-card — wraps to a column at phone width */
  pulseCard: {
    gap: 20,
    paddingVertical: 22,
