...
export const SessionStatsSheet = ({ visible, onClose, sessionEarnings, peak, inRoom, sessionGifts }: SessionStatsSheetProps) => (
  <BottomSheet visible={visible} onClose={onClose} title="Session stats" snapPoints={[0.36]}>
    <View style={styles.statsSheet}>
      ...
      <View style={styles.statCell}>
        ...
        <Text variant="h2" color="textPrimary">{inRoom}</Text>
      </View>
      <View style={styles.statCell}>
